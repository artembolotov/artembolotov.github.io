...
Отдельно раздражало, когда часть изображения просто «съедалась» криво наклеенным стеклом. Поэтому я нарисовал чёрный прямоугольник с белой границей под размер экрана и сохранил в галерею. Приложил стекло так, чтобы он был виден полностью, прижал. Идеально!
...
Нужен был сайт. Попробовал ChatGPT, DeepSeek, Qwen, Gemini — все изображали бурную деятельность, но результат был так себе.
