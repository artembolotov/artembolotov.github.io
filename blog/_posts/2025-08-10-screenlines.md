...
**Конфетти за успех** — психология важна:
...
1. **ChatGPT** — создал структуру
2. **DeepSeek** — оптимизировал JavaScript  
3. **Qwen** — экспериментировал с анимациями
4. **Gemini** — пробовал SEO
...
### Честные отзывы от животных

Меня всегда раздражали фейковые отзывы: «Андрей, фото, должность, восторг». Все понимают, что люди не существуют.

Решил по-честному — пусть отзывы пишут животные! Кошка Луна, Щенок Топик, Кролик Бургер, Пандочка Лапочка, Лисичка Искринка и Енот Полоскунчик.

![Енот устанавливает стекло](/blog/img/2025-08-10-screenlines/raccoon-hero.png)
*Енот, нарисованный ChatGPT*
...
title: "ScreenLines: как белая линия обогнала «Парковки Москвы»"
description: "История о том, как раздражающая проблема с защитным стеклом превратилась в топ-40 App Store за 3 дня"
tags: [iosdev, notes]
image: /blog/img/2025-08-10-screenlines/preview.png
---

5000 скачиваний за три дня. 34 место в топе утилит App Store России. Обогнали «Парковки Москвы» и «Столото». И всё это — приложение, которое просто показывает белую линию на экране.
...
## Проблема за 2000 рублей

Чёрная рамка стекла, чёрная рамка телефона — как определить, ровно ли легло? Не очень ровно — отклеиваем, центруем заново. Попала пылинка — доставать или оставить? Результат предсказуем: либо «съедена» часть экрана, либо белая полоска сбоку. А переклеивать — это пыль, пузыри и испорченные нервы.

В сервисных центрах за эту процедуру берут от 500 до 2000 рублей. Существуют стёкла с аппликаторами, но зачем переплачивать за одноразовую пластиковую рамку? А что если решить проблему программно?

## Эврика в сервисном центре

История началась банально. Очередное защитное стекло, очередная попытка «на глаз». И тут простая мысль: а что если включить телефон? На экране можно что-то отобразить!

Первая версия — белый прямоугольник по размеру экрана, сохранённый в галерею. Открыл фото, приложил стекло так, чтобы белая рамка была видна равномерно, прижал. Идеально!

Проверил гипотезу на друзьях. Даже те, у кого «руки не из того места» (их слова), смогли наклеить стекло идеально с первого раза. 100% успеха — такого не бывает, но было.

![Дочь клеит стекло с помощью ScreenLines](/blog/img/2025-08-10-screenlines/daughter-installing.jpg)
*Моя дочь успешно клеит стекло с первого раза*
