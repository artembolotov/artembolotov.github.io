...
Если вы хоть раз пытались наклеить защитное стекло на iPhone, то знаете эту боль. Черные рамки стекла, черный выключенный телефон, и вы пытаетесь на глаз определить, ровно ли легло стекло. Результат предсказуем: либо съедена часть экрана с одной стороны, либо видна белая полоска с другой. А переклеивать — это пыль, пузыри и испорченные нервы.
...
- **География**: Россия, США, Германия, Израиль
...
- MVP можно проверить фотографией из галереи
...
**P.S.** Если вы дочитали до конца и у вас iPhone — попробуйте [ScreenLines](https://apps.apple.com/app/id6739783494). Это бесплатно.
...
- [ScreenLines в App Store](https://apps.apple.com/app/id6739783494)
- [Сайт проекта](https://screenlines.app)
