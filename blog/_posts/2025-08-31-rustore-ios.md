...
С 1 сентября 2025 года в России вступает в силу закон, обязывающий производителей предустанавливать RuStore на все продаваемые устройства, включая iPhone. Возможно ли невозможное на закрытой платформе iOS? И что будет с критически важными функциями вроде push-уведомлений?
